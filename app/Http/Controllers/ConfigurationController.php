...
class ConfigurationController extends Controller
{
    ...
    public function getConfigurationVariable()
    {
        ...
        ///trae medios
        if ($type === 'medios') {
            $medios = isset($system_variables['medios']) ? $system_variables['medios'] : [];
            return $this->success(compact('medios'));
        }
        //

        ///trae dispositivos
        if ($type === 'dispositivos') {
            $dispositivos = isset($system_variables['dispositivos']) ? $system_variables['dispositivos'] : [];
            return $this->success(compact('dispositivos'));
        }
        //
